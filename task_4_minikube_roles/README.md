...
| `{team}-service-editor` | управление сервисами и ingress'ами в namespace                                                                       | `{team}-devops`                             |
| `{team}-config-editor`  | создание и редактирование ConfigMap (без чтения секретов)                                                            | `{team}-devops`                             |
| `{team}-secret-reader`  | чтение секретов в namespace                                                                                          | `{team}-lead-devops` (раздавать минимально) |
